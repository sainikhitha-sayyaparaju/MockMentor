"""
Django settings for MockMentor project.
...
SECRET_KEY = 'django-insecure-l1_j)ie1qkb2f43rz*$2snskymbitfls%ops*12fvq^9gpe_(3'
...
WSGI_APPLICATION = 'MockMentor.wsgi.application'
